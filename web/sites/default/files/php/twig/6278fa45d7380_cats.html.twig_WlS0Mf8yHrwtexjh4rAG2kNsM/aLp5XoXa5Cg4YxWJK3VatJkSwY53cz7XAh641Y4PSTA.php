      ...
      <div class=\"sec-col\">
        ...
        ";
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "hasPermission", [0 => "access to edit cats list"], "method", false, false, true, 18)) {
                // line 19
                echo "          <div class=\"cat_actions\">
            <a class=\"use-ajax\" data-dialog-type=\"modal\" href=\"/vinvit/cats/delete/";
                // line 20
                ...
                echo "\">Edit</a>
            <a class=\"use-qajax\" data-dialog-type=\"modal\" href=\"/vinvit/cats/delete/";
                // line 21
      ...
      <div class=\"sec-col\">
        ...
        {% if user.hasPermission('access to edit cats list') %}
          <div class=\"cat_actions\">
            <a class=\"use-ajax\" data-dialog-type=\"modal\" href=\"/vinvit/cats/delete/{{ cat.id }}\">Edit</a>
            <a class=\"use-qajax\" data-dialog-type=\"modal\" href=\"/vinvit/cats/delete/{{ cat.id }}\">Delete</a>
          </div>
        {% endif %}
      </div>
    </div>
